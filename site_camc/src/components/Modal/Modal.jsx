            ...
            <div className="mt-2 text-center sm:ml-4 sm:text-left">
              ...
              <div className="items-center place-content-center mt-3 sm:flex md:p-7 space-y-3">
                <div className="grid grid-cols-4 gap-5 place-items-center font-bold text-md">
                  ...
                  <MenuButton link={descriptionsCourse[value].link} 
                  className="place-self-center font-['Consolas'] text-violet-100 rounded-md p-3 bg-white" 
                  text="Inscreva-se!"/>
                  {/* <div className="flex gap-5">
                    <BiBody className="place-self-center"/>
                    <span className="place-self-center font-['Consolas']">
                      {descriptionsCourse[value].capacity}
                    </span> */}
                    {/* </div> */}
                  <div className="col-start-2 col-end-4 grid grid-cols-2 gap-5">
                      {/* <BiArrowFromBottom className="" /> */}
                      {/* <span className="place-self-center">Inscreva-se!</span> */}
                  </div>
                </div>
              </div>
            </div>
