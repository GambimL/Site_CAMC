      ...
      return <div key={index} className="hover:border-2 cursor-pointer">
        <div className="w-[270px] col-span-3 rounded-md bg-slate-900 shadow-lg dark:shadow-none dark:ring-1 dark:ring-inset dark:ring-white/10 ml-0">
          <div className="static flex text-md leading-6 text-slate-400 border-solid border-b border-t border-sky-300 border-t-transparent">
            <div className="mt-2 flex flex-none text-lg items-center px-24 py-1 font-bold text-sky-300">{value.time}</div>
          </div>
        </div>
...
export function Content() {
  ...
  return <div className="grid gap-2">
      ...
      <div className="w-[800px] col-span-3 -ml-10 rounded-xl bg-slate-900 shadow-lg dark:shadow-none dark:ring-1 dark:ring-inset dark:ring-white/10 xl:ml-0 border-gray-600 border border-solid ">
        ...
        <div className="grid place-items-center">
          <div className="flex items-center h-20 text-xl">
            ...
            <a 
              onClick={(() => { setOpen(true); openCollapse1 ? setOpenCollapse1(false) : setOpenCollapse1(true) })} className="col-span-2 hover:text-sky-700 duration-300 px-2 cursor-pointer" href='/home/#07/11'
            >
              07/11
            </a>
            ...
            <a 
            onClick={(() => { setOpen(true); openCollapse2 ? setOpenCollapse2(false) : setOpenCollapse2(true) })} 
            ...
            <a 
            onClick={(() => { setOpen(true); openCollapse3 ? setOpenCollapse3(false) : setOpenCollapse3(true) })} className="col-span-2 hover:text-sky-700 duration-300 px-2 cursor-pointer" 
            href='/home/#09/11'>
              09/11
            </a>
          </div>
    ...
    {open && <div className="grid gap-3 mx-auto my-10 w-[800px] drop-shadow rounded-xl text-center">
