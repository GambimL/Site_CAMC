        ...
        (visible == true) ?
            <div className="w-full h-96 flex flex-col md:hidden items-center justify-center bg-sky-950 absolute right-0 top-0">
                ...
                {props.titles.map((title) => (
                    <div className="m-8 border-b-4 py-3 w-1/3 hover:w-1/2 cursor-pointer rounded-sm duration-100 border-solid hover:border-sky-700 group border-white capitalize">
            ...
            <div>
                <div className="h-auto w-auto md:hidden cursor-pointer" onClick={() => setVisible(true)}>
                    <TfiMenu />
                </div>
            </div>
    )
