export function Speaker(props) {
    return (
        <div className="group md:max-w-full h-64 sm:my-40 my-6 flex justify-center items-center" >
            <div className="sm:max-w-5xl sm:h-5/6 rounded-none mx-6 h-3/4 bg-violet-200 sm:rounded-lg duration-300 flex md:flex-row  flex-wrap">
                <div className=" bg-violet-200 w-1/4 h-full rounded-l-lg">
                    <img
                        src={props.avatar}
                        className="
                ...
                <div className="rounded-r-lg h-full w-3/4 flex flex-col">
                    <div className="  bg-slate-100 sm:rounded-tr-lg h-1/6 w-full items-center flex border-solid 
